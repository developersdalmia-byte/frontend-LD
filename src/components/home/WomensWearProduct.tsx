...
export default function WomensWearProduct() {
  const { products, loading, error, refresh } = useProducts({ limit: 4, category: "womens-wear" });

  return (
    <section className="w-full bg-[#fdfcfb] py-20 px-5 md:px-12">
