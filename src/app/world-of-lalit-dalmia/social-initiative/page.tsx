      ...
      <section className="py-24 px-6 max-w-3xl mx-auto">
        <div className="space-y-16 text-center">
           <div className="space-y-10">
             {/* <span className="text-[10px] tracking-[0.4em] uppercase text-gray-400">The ISCOW Foundation</span> */}
             {/* <h2 className="text-3xl md:text-5xl font-bold uppercase leading-tight tracking-widest text-black">
               A Quiet Anchor
             </h2> */}
